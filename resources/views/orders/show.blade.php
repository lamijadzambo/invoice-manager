                    ...
                    <div class="card-body">
                        <div class="order-export">
                            ...
                            <div class="d-flex mt-3 mb-5">
                                <a href="{{ route('generate-man-pdf', ['project_id'=>$project_id, 'id'=>$order->id] ) }}" class="btn btn-dark mr-2"><i class="fas fa-file-download mr-1"></i> PDF Man</a>
                                <a href="{{ route('generate-woman-pdf', ['project_id'=>$project_id, 'id'=>$order->id]) }}" class="btn btn-dark mr-2"><i class="fas fa-file-download mr-1"></i> PDF Woman</a>
                                <a href="{{ route('generate-man-doc', ['project_id'=>$project_id, 'id'=>$order->id]) }}" class="btn btn-info mr-2"><i class="fas fa-file-download mr-1"></i> Word Man</a>
                                <a href="{{ route('generate-woman-doc', ['project_id'=>$project_id, 'id'=>$order->id]) }}" class="btn btn-info"><i class="fas fa-file-download mr-1"></i> Word Woman</a>
                            </div>
                        </div>
